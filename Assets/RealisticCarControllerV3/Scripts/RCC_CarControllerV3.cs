...
public class RCC_CarControllerV3 : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        Debug.Log("SteerInput of the player " + this.gameObject.name + " " + steerInput);
    ...
    private void CheckForDrift()
    {
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            Debug.Log("######Drift config########## " + highspeedsteerAngle);
            _isDrift = true;
        }
        if (Input.GetKeyUp(KeyCode.Space))
        {
            highspeedsteerAngle = 15f;
            Debug.Log("Drift config reset " + highspeedsteerAngle);
        }
    }
    ...
    public void Inputs()
    {
        ...
        switch (RCCSettings.controllerType)
        {
            ...
            case RCC_Settings.ControllerType.Keyboard:
                ...
                if (handbrakeInput > 0)
                {
                    Debug.LogError("Handbrakeinputbefore" + handbrakeInput);
                    handbrakeInput = 0.4f;
                    Debug.LogError("Handbrakeinput after" + handbrakeInput);
                }
    ...
    public void Uncontrollable()
    {
        if (_isAi)
        {
            Debug.LogWarning("Uncontrollable");
    ...
    {
        steerInput = 1;
        Debug.LogWarning("Uncontrollable " + steerInput);
    ...
    IEnumerator ResotoreDefaultMass()
    {
        ...
        #region
        Debug.LogError("Mass" + rigid.mass);
