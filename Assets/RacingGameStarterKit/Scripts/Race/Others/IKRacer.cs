...
namespace RGSK {
    ...
    public class IKRacer : MonoBehaviour {
        ...
        private RCC_CarControllerV3 rcc_car_controller;
        ...
        void Awake () {
            ...
            if (transform.root.GetComponent<RCC_CarControllerV3> ()) {
                rcc_car_controller = transform.root.GetComponent<RCC_CarControllerV3> ();
            }
        ...
        void LateUpdate () {
            ...
            for (int i = 1; i < Lfingers.Length; i++) {
                //Debug.Log ("Setting Hands Rotation");
        ...
        void HeadLook () {
            if (rcc_car_controller) steer = rcc_car_controller.steerInput;
