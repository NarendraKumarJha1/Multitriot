...
namespace RGSK
{
    ...
    public class CinematicCamera : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (!CameraPositionsParent)
                CameraPositionsParent = FindObjectOfType<WaypointCircuit>().transform;
        ...
        void GetTarget()
        {
            List<PhotonView> pvs = FindObjectsOfType<PhotonView>().ToList();

            PhotonView myPv = pvs.Find(x => x.IsMine);
            ...
            else
            {
                ...
                if (!myPv)
                    target = myPv.gameObject.transform;
            }
        }
