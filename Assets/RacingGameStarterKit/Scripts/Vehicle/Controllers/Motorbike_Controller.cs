...
namespace RGSK {
    public class Motorbike_Controller : MonoBehaviour {
        ...
        void SetupWheels () {
            ...
            wheeltransformList.Add (frontWheelTransform);
            wheelcolliderList.Add (frontWheelCollider);
            wheelsComponent.Add (frontWheelCollider.GetComponent<Wheels> ());
            wheeltransformList.Add (rearWheelTransform);
            wheelcolliderList.Add (rearWheelCollider);
            wheelsComponent.Add (rearWheelCollider.GetComponent<Wheels> ());
