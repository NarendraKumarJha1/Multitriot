...
namespace RGSK
{
    public class Car_Controller : MonoBehaviour
    {
        ...
        public enum Propulsion { RWD, FWD, AWD }
        ...
        public float maxSteerAngleAtHighSpeed = 15.0f;
        ...
        void SetupWheels()
        {
            ...
            wheelsComponent.Add(FL_WheelCollider.GetComponent<Wheels>());
            wheeltransformList.Add(FR_Wheel);
            wheelcolliderList.Add(FR_WheelCollider);
            wheelsComponent.Add(FR_WheelCollider.GetComponent<Wheels>());
            wheeltransformList.Add(RL_Wheel);
            wheelcolliderList.Add(RL_WheelCollider);
            wheelsComponent.Add(RL_WheelCollider.GetComponent<Wheels>());
            wheeltransformList.Add(RR_Wheel);
            wheelcolliderList.Add(RR_WheelCollider);
            wheelsComponent.Add(RR_WheelCollider.GetComponent<Wheels>());
        ...
        void Drive()
        {
            ...
            // if (currentSpeed > 100)
            //     currentSteerAngle = Mathf.Clamp (currentSteerAngle, 0, maxSteerAngleAtHighSpeed);
        ...
        {
            //Footbrake
            if (!reversing && brakeInput > 0.0f && handbrakeInput < 0.08f)
            {
                ...
                else if (_propulsion == Propulsion.FWD)
                {
            ...
            {
                handbrakeInput = 0;
                Debug.LogError("handbrake"+ handbrakeInput);
            }
        ...
        void Traction()
        {
            switch (_propulsion)
            {
                ...
                case Propulsion.AWD:
                    WheelFrictionCurve _rearWheelStiffness = RL_WheelCollider.sidewaysFriction;
                    _rearWheelStiffness.stiffness = traction + 1.0f;

                    RL_WheelCollider.sidewaysFriction = _rearWheelStiffness;
                    RR_WheelCollider.sidewaysFriction = _rearWheelStiffness;

                    WheelFrictionCurve _frontWheelStiffness = FL_WheelCollider.sidewaysFriction;
                    _frontWheelStiffness.stiffness = traction + 1.0f;

                    FL_WheelCollider.sidewaysFriction = _frontWheelStiffness;
                    FR_WheelCollider.sidewaysFriction = _frontWheelStiffness;
                    break;
